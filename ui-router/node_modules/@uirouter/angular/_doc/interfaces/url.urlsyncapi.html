...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/85f43cc/src/url/interface.ts#L193">core/src/url/interface.ts:193</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/85f43cc/src/url/interface.ts#L167">core/src/url/interface.ts:167</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/85f43cc/src/url/interface.ts#L145">core/src/url/interface.ts:145</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
