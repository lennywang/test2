 ...
 * @module ng
 * @description
 * An object that contains information about the current JS version. This object has the
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       *
       * Note that, in JS, there is also a `$destroy` jQuery event, which can be used to
       * clean up DOM bindings before an element is removed from the DOM.
       */
      $destroy: function() {
...
var styleDirective = valueFn({
  ...
  if (window.angular.bootstrap) {
    //JS is already loaded, so we can return here...
